...
- Toasts restyled as a catalog drawer slip for Undo actions and a compact ink-slip chip for success/error (shared palette, HugeIcons glyphs, top-right entry/exit, ~2.5s auto-dismiss for status) (`src/App.tsx`, `src/App.css`)
